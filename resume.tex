...
\begin{entrylist}
    \volunteering[
        ...
        Instructor of level 1 teaching topics from Assiut university sheet. Each week there is a session.
        In this level I taught topics such as binary search, greedy algorithms, STL library, and much more.
    }
    ...
    \volunteering[
        ...
        \begin{items}
        \item Directed the committee to build 13+ telegram bots that help students get the learning materials.
