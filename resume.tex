...
{\fontsize{36}{36} \selectfont\scshape{Muhammad AL-Sawalhy}}
...
\begin{entrylist}
    \volunteering[
        ...
        \begin{items}
        \item Instructor of level 1 teaching topics from Assiut university sheet
        \item Each week there is a session which lasts around 2 hours
        \item This level contains topics such as binary search, greedy algorithms, and STL library
        \end{items}
    }
    ...
    \volunteering[
        ...
        \begin{items}
        \item Directed the committee to build 13+ telegram bots that help students get their learning materials
        \item Automated processes and repeated tasks using Python and Make (Integromat)
